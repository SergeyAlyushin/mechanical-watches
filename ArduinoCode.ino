...
int SER_Pin = 12;   //pin 14 on the 74HC595
int RCLK_Pin = 11;  //pin 12 on the 74HC595
int SRCLK_Pin = 10; //pin 11 on the 74HC595
...
void setup() {
  ...
  //If SW2 pressed on boot change time to UTC +3 (CEST)
  if(digitalRead(SW2)){
    timezoneOffset = 3;
  }
